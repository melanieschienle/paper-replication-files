...
# redirect output
file.remove("output_Table8.txt")
sink(file = "output_Table8.txt", append = TRUE, type = c("output", "message"), split = FALSE)
...
n        <- 200
n_window <- 0 # stands for no shift, meaning that the post event window starts immediately after the event
